...
var AppModule = (function () {
    ...
    AppModule = __decorate([
        core_1.NgModule({
            imports: [platform_browser_1.BrowserModule, forms_1.FormsModule, title_module_1.TitleModule, http_1.HttpModule],
            declarations: [app_component_1.AppComponent, item_1.Item, item_form_1.ItemForm, item_filter_1.ItemPipe],
            bootstrap: [app_component_1.AppComponent],
            providers: [item_service_1.ItemService, collection_service_1.CollectionService, socket_service_1.SocketService]
        }), 
